...
def get_errors(y_test, y_hat, chan_id, run_id, smoothed=True):
    ...
    Args:
        ...
        smoothed (bool): If False, return unsmoothed errors (used for assessing quality of predictions)
...
def get_anomalies(e_s, y_test, z, window, i_anom_full, len_y_test):
    ...
    Returns:
        i_anom (list): indices of errors that are part of an anomalous sequence
    '''
    config = Config("_config_files/config_new.yaml")
